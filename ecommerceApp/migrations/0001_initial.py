    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order Received', 'Order Received'), ('Order Processing', 'Order Processing'), ('On the way', 'On the way'), ('Order Cancelled', 'Order Cancelled'), ('Order Completed', 'Order Completed')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
